...
// 2. FIXED: Remove unique constraint from originalUrl (too restrictive)
ContentSchema.index(
...
// 3. FIXED: Remove unique constraint from contentHash (causing issues)
ContentSchema.index(
  { contentHash: 1 },
  {
    partialFilterExpression: { 
...
// 4. Keep normalized title index (no unique constraint)
ContentSchema.index(
