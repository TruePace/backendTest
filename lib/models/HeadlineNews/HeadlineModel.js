...
// Updated Content Schema with externalId field
const ContentSchema = new mongoose.Schema({
  ...
  source: { type: String, default: 'internal' }, // 'internal' or 'external'
  originalSource: { type: String }, // For external news, the name of the original source
  originalUrl: { type: String }, // For external news, link to original article
  externalId: { type: String, unique: true, sparse: true } // For tracking external news uniqueness
});

// Add index for externalId for faster lookups
