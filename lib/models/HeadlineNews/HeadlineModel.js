...
const UserSchema = new mongoose.Schema({
  ...
  interests: [String], // Tags or categories the user is interested in
  lastActive: { type: Date, default: Date.now },
  deviceInfo: { type: String }, // Store device type (mobile/desktop) or OS
  location: { type: String }, // Store user's general location (city/country)
  readingHistory: [{ type: mongoose.Schema.Types.ObjectId, ref: 'BeyondArticle' }],
  interactionScores: { type: Map, of: Number }, // Store interaction scores for different topics
});
