// Updated HeadlineNewsContentController.js - Add content existence check
...
// NEW: Check if content exists by ID
...
const postHeadlineNewsContent = async (req, res) => {
  try {
    // Check if content with this ID already exists (for external news)
    if (req.body._id) {
...
export {
  ...
  getUserInteraction,
  checkContentExists // Export the new function
};