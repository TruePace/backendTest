// HeadlineNewsJustInController.js - Cleaned version without external news logic
...
const getHeadlineContent = async (req, res) => {
  try {
    ...
    // Clean up expired internal content only (24hr rule)
...
const postNewContent = async (req, res) => {
  try {
    ...
    if (isExternal) {
      // External news: 48 hours from published date (handled by frontend)
