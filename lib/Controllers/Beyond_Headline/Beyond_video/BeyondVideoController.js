...
export const postBeyondVideoComment = async (req, res) => {
  try {
    ...
    // Use the custom username if it exists, otherwise fall back to displayName or email
    ...
    const newComment = new BeyondVidComment({
      ...
      text,
      replyTo,
      picture: user.photoURL  // Add this if you want to include the user's photo
    });
